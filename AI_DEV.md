...
flowchart TD
    ...
    EXTRA --> K
    SELECT --> PLAN["План в контексте сессии; при необходимости файл в .superpowers/"]
...
[AGENTS.md](AGENTS.md#проектные-документы-и-правила-продукта). При создании
`unica-development` этот порядок переносится в него целиком. Локальные
