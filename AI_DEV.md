...
Схема обновлена 2026-09-17. Она показывает, **когда агент узнаёт ограничение
и что вызывает следующее чтение**. Десять правил приняты владельцем;
...
Он находит правило из пилота. Связь в общем случае не обязана
