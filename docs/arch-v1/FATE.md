...
| `ADR-0016` | `superseded` | `CTR.FORMAT.PLATFORM-XML-8-3-27`, `INV.PRODUCT.FULL-DUMP-PROFILE`, `INV.SOURCE.ATOMIC-PUBLISH`, `INV.SOURCE.BOUND-HANDLER-PREFLIGHT`, `INV.SOURCE.BOUND-PREIMAGES`, `INV.SOURCE.ENTITY-SPELLED-VERSION`, `INV.SOURCE.EXACT-ROOT-FORM`, `INV.SOURCE.EXACT-ROOT-QNAME`, `INV.SOURCE.EXACT-ROOT-VERSIONLESS`, `INV.SOURCE.EXACT-VERSION`, `INV.SOURCE.EXACT-VERSION-LITERAL`, `INV.SOURCE.FORMAT-PER-SET`, `INV.SOURCE.PLATFORM-XML-ONLY`, `INV.SOURCE.ROLLBACK-DIAGNOSTIC-CLASS`, `INV.SOURCE.ROLLBACK-VISIBLE`, `INV.SOURCE.ROOT-POLICIES`, `INV.SOURCE.ROOT-POLICIES-CLOSED`, `INV.SOURCE.ROOT-POLICY-OWNERSHIP`, `INV.SOURCE.ROOT-POLICY-PUBLICATION` | — |
...
| `INV-SOURCE-PORTABLE-GIT` | `carried` | `INV.SOURCE.PORTABLE-GIT` | — |
...
| `INV-SOURCE-PLATFORM-XML-ONLY` | `carried` | `INV.SOURCE.PLATFORM-XML-ONLY` | — |
| `INV-SOURCE-SINGLE-RESOLVED-ROOT` | `superseded` | `INV.SOURCE.DEFAULT-SET-SELECTION` | — |
| `INV-SOURCE-LOGICAL-IDENTITY` | `carried` | `INV.SOURCE.LOGICAL-IDENTITY` | — |
...
| `INV-SOURCE-IDEMPOTENT-REWRITE` | `superseded` | `INV.SOURCE.IDEMPOTENT-REWRITE`, `INV.SOURCE.IDEMPOTENT-EFFECTS`, `INV.SOURCE.IDEMPOTENT-PRECHECK`, `INV.SOURCE.IDEMPOTENT-CONSUMED-SELECTOR` | — |
