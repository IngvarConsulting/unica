...
`ADR-0074` пришёл в архив слиянием после заморозки: он писался на `main`, где переименование каталога ещё не произошло. Это история, приехавшая с опозданием, а не правка замороженного, поэтому запись принята и распоряжена здесь. Правки main в записях, существовавших на момент заморозки, приняты не были.
