...
| `INV-MCP-SURFACE-SYNC` | `superseded` | `CTR.WIRE.TOOL-SURFACE`, `INV.REGISTRY.CHECK-EXISTS`, `INV.REGISTRY.RECIPROCAL-OWNERSHIP`, `INV.SURFACE.CHANGESET-COHERENCE`, `INV.SURFACE.PARITY-HARNESS-COVERAGE` | — |
| `INV-MCP-TYPED-RESULT` | `superseded` | `INV.APP.CODE-DEFINITION-READINESS`, `INV.SURFACE.RESULT-CONTRACTS-MATCH-REVIEW`, `INV.WIRE.PREVIEW-IS-MUTATION-ONLY`, `INV.WIRE.TYPED-READ-FINALIZER` | — |
...
| `REQ-TOKEN-NO-EXTRA-ROUNDTRIP` | `superseded` | `INV.CACHE.MUTATION-EVENT-COVERAGE`, `INV.CACHE.EVENT-IMPACT-CLOSED`, `INV.CACHE.REPORTED-EFFECTS`, `INV.TOKEN.CACHE-IMPACT-IN-RESULT` | — |
...
| `REQ-COMPAT-FORMAT-PROFILE` | `superseded` | `INV.PRODUCT.FULL-DUMP-PROFILE`, `INV.SOURCE.WRITABLE-PROFILE`, `DEC.2026-08-21.PLATFORM-XML-PROFILE` | — |
