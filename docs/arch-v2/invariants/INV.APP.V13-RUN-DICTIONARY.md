...
Каталог v0.13 публикует закрытый словарь намерений `unica.run`; его состав
владеет проверка, а не счёт в этой прозе. `query.execute` среди них
отсутствует и не имеет alias или capability-преемника в v0.13.
