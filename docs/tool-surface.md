...
**Целевой контракт:** Добавить actor-owned nofollow/cancellation reader для документации конфигурации, выбор locale и version; развернуть курсор v8std на публичном сервере и проверить через установленный пакет
...
**Целевой контракт:** При 200 полученных совпадениях предложить уточнить запрос; не обещать продолжение за окном поставщика и сохранять честный признак неполноты.
