...
[`../design/2026-07-26-versioned-source-adapter-architecture.md`](../design/2026-07-26-versioned-source-adapter-architecture.md).

This historical first-slice plan is related to Tasks 1-7 of
[`2026-07-26-versioned-format-adapter-boundary.md`](2026-07-26-versioned-format-adapter-boundary.md).
It does not supersede that plan and does not claim Task 8 writer completion.
