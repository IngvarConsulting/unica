...
**Design source:** [`../design/2026-07-26-versioned-format-adapter-boundary-design.md`](../design/2026-07-26-versioned-format-adapter-boundary-design.md)

**Current status after the 2026-07-29 main merge:** Tasks 1-7 are implemented
on this branch. Task 8 remains under review and is not complete or `write-safe`.
Tasks 9-12 remain in progress or pending; this merge resolution does not claim
their completion and does not run Task 12 validation.
