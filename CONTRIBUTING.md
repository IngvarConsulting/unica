...
агентов](AGENTS.md) и относящиеся к задаче [правила продукта](arch/README.md).
Архитектурный пилот содержит первые десять правил; отсутствие записи не
отменяет существующие гарантии и их проверки. Этот документ описывает локальное
...
Обычная правка Unica не требует всего комплекта. Рабочий вход пока находится
в [AGENTS.md](AGENTS.md); локальные скиллы разработки будут подключены после
вычитки архитектурного пилота.
