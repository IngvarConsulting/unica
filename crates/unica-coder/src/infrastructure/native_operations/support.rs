...
fn preflight_required_vendor_payloads(
    ...
    Err(format!(
        "Capability=on cannot be applied: missing required vendor payload(s): {}. ParentConfigurations.bin was not changed; export the matching vendor configuration payload with the 1C platform first.",
        missing
            .iter()
