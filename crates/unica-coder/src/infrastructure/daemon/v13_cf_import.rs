...
//! внешний файл настроек объединения, а `update` совместимый раннер 0.11.2 не поддерживает.
//!
...
/// Состояния совместимости, которые раннер 0.11.2 обещает в `compatibility_state`.
