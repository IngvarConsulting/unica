...
pub struct Kb1ciProvider {
    ...
    /// заголовкам площадки (ADR-0037 п.4).
    ...
    fn search(
        ...
        corpora
            ...
            .map(|(corpus_id, guides)| {
                ...
                // Матчинг — лексическим ядром по заголовкам узлов (ADR-0037
...
mod provider_tests {
    ...
    /// Ядро ADR-0037 в kb: слова запроса совпадают с заголовком узла
    ...
    /// лексикон установки (ADR-0037 п.4); без установки — честный Empty,
