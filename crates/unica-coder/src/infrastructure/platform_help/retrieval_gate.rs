//! Ретривал-гейт: golden-запросы задачи #415 против реальной
...
//! Замер #415 состоял из восьми запросов. До лексического поиска пять
//! отвечали пустой секцией; они составляют ядро набора. Восьмой запрос —
