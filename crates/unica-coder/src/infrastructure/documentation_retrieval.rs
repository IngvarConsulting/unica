//! Лексическое ядро `unica.documentation.search` (ADR-0036): токенизация,
...
/// признак, что спрошено именно это имя; ADR-0036 требует ранжировать точное
...
/// (kb-1ci), когда установка доступна (ADR-0036 п.4).
