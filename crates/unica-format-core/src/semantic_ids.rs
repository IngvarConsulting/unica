...
semantic_id_registry!(
    ...
    SemanticPropertyId {
        ...
        LOCK_CONTROL_MODE => "locking.controlMode",
        FULL_TEXT_SEARCH_MODE => "search.fullText.mode",
        CHOICE_MODE => "choice.mode",
        CODE_ALLOWED_LENGTH => "code.allowedLength",
        CODE_TYPE => "code.type",
        DEFAULT_PRESENTATION_MODE => "presentation.defaultMode",
        CALCULATION_DEPENDENCE_MODE => "calculation.dependenceMode",
        EDIT_MODE => "editing.mode",
        NUMBER_ALLOWED_LENGTH => "number.allowedLength",
        NUMBER_TYPE => "number.type",
        SUBORDINATION_USE => "subordination.use",
...
semantic_id_registry!(
    ...
    SemanticEnumValue {
        ...
        TO_GROUPS => "toGroups",
        TO_GROUPS_AND_ITEMS => "toGroupsAndItems",
        TO_ITEMS => "toItems",
        NOT_SUPPORTED => "notSupported",
        REMOVED_FROM_SUPPORT => "removedFromSupport",
        SUPPORTED_EDITABLE => "supportedEditable",
        SUPPORTED_LOCKED => "supportedLocked",
        CONFIGURATION_READ_ONLY => "configurationReadOnly",
    }
);
