...
pub const SEMANTIC_PROPERTY_DEFINITIONS: &[SemanticPropertyDefinition] = &[
    ...
    fixed!(SUPPORT_STATE, Enum),
    fixed!(SUPPORT_AUTHORABILITY, String),
    fixed!(SUPPORT_EDIT_CAPABILITY, String),
    fixed!(LOCK_CONTROL_MODE, Enum),
    fixed!(FULL_TEXT_SEARCH_MODE, Enum),
    fixed!(CHOICE_MODE, Enum),
    fixed!(CODE_ALLOWED_LENGTH, Enum),
    fixed!(CODE_TYPE, Enum),
    fixed!(DEFAULT_PRESENTATION_MODE, Enum),
    fixed!(CALCULATION_DEPENDENCE_MODE, Enum),
    fixed!(EDIT_MODE, Enum),
    fixed!(NUMBER_ALLOWED_LENGTH, Enum),
    fixed!(NUMBER_TYPE, Enum),
    fixed!(SUBORDINATION_USE, Enum),
    ...
    fixed!(CATALOG_HIERARCHICAL, Boolean),
    fixed!(CATALOG_HIERARCHY_TYPE, Enum),
    fixed!(CATALOG_HIERARCHY_LEVEL_LIMITED, Boolean),
    ...
    fixed!(FORM_TYPE, Enum),
    fixed!(TEMPLATE_TYPE, Enum),
    ...
    fixed!(ACCESS_NEW_OBJECTS_DEFAULT, Boolean),
    fixed!(ACCESS_ATTRIBUTES_DEFAULT, Boolean),
    fixed!(ACCESS_CHILD_OBJECTS_INDEPENDENT, Boolean),
    fixed!(ACCESS_PERMISSION_NAME, String),
    fixed!(ACCESS_PERMISSION_ALLOWED, Boolean),
    fixed!(ACCESS_RESTRICTION_CONDITIONS, List),
    fixed!(BACKING_DESCRIPTOR_AVAILABLE, Boolean),
    fixed!(BACKING_DESCRIPTOR_UUID, Uuid),
    fixed!(BACKING_CONTENT_AVAILABLE, Boolean),
    fixed!(BACKING_CONTENT_OPAQUE, Boolean),
    fixed!(UNKNOWN_FACTS, List),
];
