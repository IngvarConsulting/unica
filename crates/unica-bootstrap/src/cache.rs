...
impl RuntimeInstaller {
    ...
    /// Пока защищены только версии под блокировкой доставки. Удержание версии
    /// живым потребителем ещё не реализовано (issue #926): после очистки
    /// повторный вызов старой сессии может потребовать недоступной загрузки.
