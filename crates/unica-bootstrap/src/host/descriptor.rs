...
/// Claude Code always scans `skills/`, so naming the directory in the manifest
/// would load it twice. It hands every plugin its own data directory, which is
/// where the runtime cache belongs.
