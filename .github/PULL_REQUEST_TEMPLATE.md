...
правила: он падает, если ни один нормативный документ — запись решения,
`invariants.md`, `quality-requirements.md` или план приёмки — не изменился
вместе с реестром инструментов. Что изменённый документ действительно владеет
этим инструментом, подтверждает ревью.
