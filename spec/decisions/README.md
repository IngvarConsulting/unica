...
- `0020` — израсходован на первый вариант решения для issue #262, отозванный до
  попадания в целевую ветку. Файла `0020-*.md` нет; действующий объединённый
  контракт оформлен ADR-0021.
