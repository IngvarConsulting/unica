...
- [ADR-0029: Предопределённые элементы и права роли изменяются типизированными логическими операциями](0029-typed-predefined-items-and-logical-role-edit.md)
