...
- [ADR-0035: Находки проверки метаданных несут код правила и языковое местоположение](0035-tipizirovannye-nahodki-validacii-meta.md)
- [ADR-0036: Адрес и эффективная роль подсистемы выводятся из зарегистрированной топологии](0036-subsystem-address-and-effective-role.md)
- [ADR-0037: Лексическое ядро поиска по документации](0037-leksicheskoe-yadro-poiska-dokumentacii.md)
- [ADR-0038: Источник подписки задаётся типизированным отношением метаданных](0038-event-subscription-source-relation.md)
- [ADR-0039: Подписка валидируется как единая логическая связка](0039-event-subscription-logical-binding.md)
- [ADR-0040: Операционная конфигурация рабочего пространства разрешается снимком на вызов](0040-workspace-operational-config-snapshot.md)
- [ADR-0042: Чтение метаданных не зависит от плана мутации](0042-meta-observation-does-not-depend-on-mutation.md)
- [ADR-0043: Предопределённые элементы и права роли изменяются типизированными логическими операциями](0043-typed-predefined-items-and-logical-role-edit.md)
...
- [ADR-0061: Многофайловый RLM входит в runtime замкнутой полезной нагрузкой](0061-rlm-mnogofaylovyy-runtime-iz-proveryaemogo-arhiva.md)
- [ADR-0062: Готовность RLM является типизированным состоянием](0062-tipizirovannaya-gotovnost-rlm.md)
...
- [ADR-0068: Публикация идёт линейным конвейером от единственного человеческого тега](0068-lineynyy-konveyer-postavki.md)
- [ADR-0069: Версии протокола MCP обслуживаются по документации SDK, гарантируются по матрице хостов](0069-versii-protokola-mcp-po-sdk.md)
- [ADR-0070: Большое чтение продолжается по ссылке без повторного вычисления](0070-prodolzhenie-bolshogo-chteniya-po-ssylke.md)
...
- [ADR-0076: Ядро запускается первым, движки доставляются неизменяемыми артефактами](0076-yadro-pervym-dvizhki-po-trebovaniyu.md)
- [ADR-0077: Обычное клиентское приложение входит в закрытый контракт свойств общего модуля](0077-common-module-ordinary-client-property.md)
...
выведенными проверяемыми правилами, либо остаётся проектным предложением.
