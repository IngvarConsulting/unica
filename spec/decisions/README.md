...
ссылается на решение-основание либо на несколько совместно владеющих одним
расширенным контрактом решений. Поэтому архитектурный выбор цитируется как
...
- [ADR-0038: Операционная конфигурация рабочего пространства разрешается снимком на вызов](0038-workspace-operational-config-snapshot.md)
