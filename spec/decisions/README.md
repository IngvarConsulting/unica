...
- [ADR-0020: Логические адреса целей не зависят от файловой раскладки](0020-logical-source-addressing.md)
- [ADR-0021: Низкоуровневый доступ к ресурсам ограничен снимком и ролью](0021-bounded-source-resource-access.md)

Записи в статусе `proposed` ещё не действуют и не заменяют принятые решения.
После ревью каждая из них либо переводится в `accepted` вместе с реализацией и
