...
- [ ] Документы ссылаются на новое правило по ID, а не пересказывают его
  (`INV-DOC-SINGLE-RULE-OWNER`), нормативные предложения написаны по-русски (`INV-DOC-RUSSIAN-NORMATIVE`), и
...
отношении: каждый процитированный здесь ID обязан существовать в реестре. Что
