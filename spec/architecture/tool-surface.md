...
- Атомарно заменить несколько ожидаемых вхождений одного модуля
...
**Результат сейчас:** типизированный `data`: проверенный постобраз либо `replacement_overlap` с конфликтующими диапазонами (ADR-0077) (отвечают типизированным `data`)
