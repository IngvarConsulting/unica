...
**Результат сейчас:** `data`: три ролевые секции с логическими местоположениями, полнотой, ранжированием, счётом и происхождением; ход приходит через typed MCP progress (ADR-0055) (отвечают типизированным `data`)
