...
- Публикуют больше 20 аргументов из общего списка: **2**
...
| Аргумент | Тип | Обяз. | Описание |
| --- | --- | --- | --- |
| `ConfigPath` | string | нет | — |
| `DefinitionFile` | string | нет | — |
| `NoValidate` | boolean | нет | — |
| `Operation` | string | нет | — |
| `Value` | string | нет | — |
| `confirm` | boolean | нет | — |
| `cwd` | string | нет | — |
| `dryRun` | boolean | нет | — |
...
| Аргумент | Тип | Обяз. | Описание |
| --- | --- | --- | --- |
| `CompatibilityMode` | string | нет | — |
| `Name` | string | нет | — |
| `OutputDir` | string | нет | — |
| `Synonym` | string | нет | — |
| `Vendor` | string | нет | — |
| `Version` | string | нет | — |
| `confirm` | boolean | нет | — |
...
| --- | --- | --- | --- |
| `ConfigPath` | string | по ветви | — |
| `Detailed` | boolean | нет | — |
| `MaxErrors` | string | нет | — |
| `confirm` | boolean | нет | — |
| `cwd` | string | нет | — |
| `sourceSet` | string | по ветви | — |
...
| Аргумент | Тип | Обяз. | Описание |
| --- | --- | --- | --- |
| `BorrowMainAttribute` | string | нет | — |
...
| --- | --- | --- | --- |
| `FormName` | string | нет | — |
| `ObjectPath` | string | нет | — |
| `Purpose` | string | нет | — |
| `SetDefault` | boolean | нет | — |
| `Synonym` | string | нет | — |
| `confirm` | boolean | нет | — |
| `cwd` | string | нет | — |
| `dryRun` | boolean | нет | — |
...
| --- | --- | --- | --- |
| `FormName` | string | нет | — |
| `ObjectName` | string | нет | — |
| `ProcessorName` | string | нет | — |
| `SrcDir` | string | нет | — |
| `confirm` | boolean | нет | — |
| `cwd` | string | нет | — |
| `dryRun` | boolean | нет | — |
