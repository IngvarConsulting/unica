...
- **Rule:** Общая предпроверка `unica.runtime.execute` и
  ...
  неизвестный селектор, неосновной файл конфигурации, а в режиме Конфигуратора
  также недоказанный или противоречащий глобальному режиму физический формат
  завершаются до запуска объяснимым отказом с рекомендацией явной полной
  пересборки. Селектор и
