...
- **Rule:** Для нормализованной пары рабочего пространства и корня исходников
  ...
  доказанный событийный барьер и не
  обходит дерево; холодный старт, изменение и потеря доверия выполняют полное
  согласование, а платформа без доказуемого барьера использует консервативное
  двойное согласование. Маркер готовности индекса хранит полную ревизию,
