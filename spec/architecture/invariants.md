...
- **Rule:** Поставщик справки платформы читает контейнеры установки и
  разбирает их в памяти на время вызова, не смешивая корпуса разных версий
  платформы. Индекс, кеш и распакованные страницы на диск не пишутся, в
  рабочее дерево не попадают и в пакет не включаются.
- **Decision:** ADR-0029
