...
- **Rule:** Для нормализованной пары рабочего пространства и корня исходников
  ...
  отсекает тот же служебный каталог `.build`, что и обход корпуса: кеши самой
  Unica лежат внутри корня исходников, и барьер, сообщающий об изменениях,
  которых нет в карте корпуса, никогда не сходится. Маркер
