...
- **Rule:** `unica.documentation.search` публикует секции поставщиков в порядке
  ...
  секция — поставщик, корпус, смысл источника и авторитетность; попадание
  внутри секции несёт применимую версию и устойчивый локатор. Ранги и оценки
...
- **Rule:** Поставщик справки платформы читает контейнеры установки и
  ...
  каталогом установки и языком и потому не смешивает корпуса разных версий
