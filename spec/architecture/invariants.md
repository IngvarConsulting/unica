...
- **Rule:** Поставщик справки платформы читает контейнеры установки и
  ...
  каталогом установки и выбранными по запросу контейнерами и потому не
  смешивает ни корпуса разных версий платформы, ни корпуса разных локалей, а
  запросы, разрешающиеся в одни и те же файлы, делят один индекс. Индекс,
