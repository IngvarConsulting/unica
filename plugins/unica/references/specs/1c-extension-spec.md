...
`unica.cfe.validate` отвергает заимствованный объект, когда файл прямого модуля
уже существует, а соответствующей единственной записи `PropertyState` со
значением `Extended` нет.
