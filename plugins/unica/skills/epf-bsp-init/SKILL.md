...
4. Если файл не найден — предложи создать scaffold через `unica.epf.init`; если external source-set не зарегистрирован в предоставленном `v8project.yaml`, сообщи о runtime contract gap и не обходи его прямым runner-ом
