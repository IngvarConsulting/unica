...
от 5 до 9 только для хранимых объектов, если режим совместимости не задан
(`DontUse`) или новее `Version8_3_26`. При `Version8_3_26` и старше платформа
фиксирует значение 5. Для `Report`, `DataProcessor`, `ExternalReport` и
