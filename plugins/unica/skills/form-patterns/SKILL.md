...
Перед выбором элементов и компоновки прочитай этот раздел в
[справочнике форм](../../references/specs/form-patterns.md). Он содержит
UX-рекомендации, примеры и ограничения поддерживаемых элементов.
