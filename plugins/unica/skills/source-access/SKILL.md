...
- Перед именованием нового или переименованного BSL-метода прочитай
  `../../references/platform/method-naming.md`; сохрани имена обработчиков
  платформы и существующий публичный API.
