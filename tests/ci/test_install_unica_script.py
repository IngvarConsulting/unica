...
class InstallUnicaScriptTests(unittest.TestCase):
    ...
    def test_shim_clones_stable_catalog_then_runs_preflight_before_migration(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(any("fetch --depth 1 origin refs/tags/v0.7.6" in line for line in calls))
...
if [ "$1" = "clone" ]; then
  ...
  printf '%s\n' '{"name":"unica","plugins":[{"name":"unica","source":{"source":"git-subdir","url":"https://github.com/IngvarConsulting/unica-marketplace.git","path":"./plugins/unica","ref":"v0.7.6"}}]}' > "$destination/.agents/plugins/marketplace.json"
