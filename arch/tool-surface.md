...
**Результат сейчас:** типизированный `data`: проверенный постобраз либо `replacement_overlap` с конфликтующими диапазонами (DEC.2026-08-22.ATOMIC-CODE-REPLACEMENT-BATCH) (отвечают типизированным `data`)
