...
| `DEC.2026-08-18.ARCHITECTURE-RESET` | решение | active | Архитектура описывается заново, архив не переносится | [decisions/2026-08-18-architecture-reset.md](decisions/2026-08-18-architecture-reset.md) |
...
| `INV.DOC.ARCHIVE-FROZEN` | инвариант | active | Архив v1 не изменяется после заморозки | [invariants/INV.DOC.ARCHIVE-FROZEN.md](invariants/INV.DOC.ARCHIVE-FROZEN.md) |
