...
20, максимум — 50. Ответ называет, завершена ли выдача полученных элементов
и почему страница остановилась: по числу элементов или по объёму. Если в
полученном потоке есть следующие элементы, страница даёт применимое
продолжение; содержимое элемента не обрезается молча. Предел поставщика
может завершить полученный поток до конца корпуса: ответ сообщает о такой
неполноте отдельно и не обещает курсор за пределами доступного окна.
...
из него не следует, что запрос слишком широк.
