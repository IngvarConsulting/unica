...
**Почему.** Один корректный дамп не должен быть адресуемым для validate и
outline, но недоступным для обязательных review-читателей из-за требования
способности к записи.
