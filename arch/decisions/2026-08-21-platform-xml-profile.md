...
Архивная матрица отклонений остаётся историческим свидетельством v1, но не
действующим реестром v2. Текущую форму определяют спецификации форматов,
проверенные фикстуры и официальный дамп платформы; отдельная полная матрица
намеренных отклонений продуктовым обещанием больше не является.
