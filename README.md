...
| Исходное состояние | Переход на `v0.7.6` | Переход на `v0.8.0` |
| --- | --- | --- |
...
| Любая локальная, дублированная или иная legacy-установка, включая версии `0.3.x`–`0.7.x` | Запустить замороженный [`install-unica.sh`](https://github.com/IngvarConsulting/unica/releases/download/v0.7.6/install-unica.sh) либо [`install-unica.ps1`](https://github.com/IngvarConsulting/unica/releases/download/v0.7.6/install-unica.ps1) из релиза `v0.7.6`. | Сначала выполнить миграцию через `v0.7.6`, затем обычное обновление marketplace. |
| Каноническая установка `v0.7.5` из `IngvarConsulting/unica-marketplace` | Выполнить обычное обновление marketplace. | Поддерживается обычное обновление marketplace. |
| Каноническая установка `v0.7.6` | Переход не требуется. | Поддерживается обычное обновление marketplace. |
| Каноническая техническая версия `0.7.x` | При необходимости перейти на стабильную `v0.7.6` обычным обновлением marketplace. | Поддерживается обычное обновление marketplace. |
...
Скрипты релиза `v0.7.6` клонируют стабильный Git-каталог, запускают
...
Замороженные ссылки `v0.7.6` выше остаются поддерживаемой точкой входа для
старых установок.
