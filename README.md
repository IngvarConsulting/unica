...
| `8.5.1.x`, `8.5.4.x` | Планируется | Поддержку планируем добавить в ближайшее время. |
| `8.3.26.x` и ниже | Не планируется | Поддержку не планируем, но помогаем мигрировать на 8.3.27. Если вам действительно нужна более старая версия, [создайте issue](https://github.com/IngvarConsulting/unica/issues/new) и опишите причину — нам важно понимать такой сценарий. |
